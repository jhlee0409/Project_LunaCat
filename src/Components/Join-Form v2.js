...
class TextInput extends React.Component {
  ...
  render() {
    ...
    return (
        <input value={text} placeholder="닉네임" maxLength='29' onChange={this.handleChange} />
    );
  }
}
            ...
            <div className='join-right'>
              <div className='join-main'>
                <form action="" method="POST">
                  <span>창작이 즐거워지는 시간</span>
                  <h3>나만의 계정 만들기!</h3>
                  <p >이메일</p>
                  <div className="inputBox">
                      <input type='email' name="join-email" id="join-email" placeholder="이메일"
                      />
                      {/* <span className="span-active">메일형식 확인</span> */}
                  </div>
                  <p>비밀번호</p>
                  <div className="inputBox">
                      <input type="password" name="join-pass1" id="join-pass1" placeholder="비밀번호"/>
                      {/* <span className="span-active">비밀번호 확인</span> */}
                      {/* <span className="span-active">최소 8자 이상</span> */}
                  </div>
                  <p >비밀번호 확인</p>
                  <div className="inputBox">
                      <input type="password" name="join-pass2" id="join-pass2" placeholder="비밀번호 확인" minLength='8'/>
                      {/* <span className="span-active">비밀번호 확인</span> */}
                  </div>
                  <p >닉네임</p>
                  <div className="inputBox">
